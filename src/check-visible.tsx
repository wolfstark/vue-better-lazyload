...
function checkContainerVisible (listener: VLazyLoad) {
  ...
  const containerRect = (listener.container.$el as HTMLElement).getBoundingClientRect()
...
function computeVisible ({ top,left,height,wdith,containerHeight,containerWidth }: any) {
